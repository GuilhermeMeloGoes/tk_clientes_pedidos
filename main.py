...
class App(tk.Tk):
    ...
    def create_frames_container(self):
        ...
        # Configura o container para que o frame filho
        # (a tela atual) o preencha completamente
    ...
    def create_all_frames(self):
        ...
        # Busca os dados do combobox ANTES de criar os frames
        try:
        ...
        for FrameClass, frame_name in [
            ...
            if frame_name == "Dashboard":
                ...
                # Conecta o callback da Análise de IA (NOVO)
                ...
                # Botão "Novo Pedido" foi movido para o menu
